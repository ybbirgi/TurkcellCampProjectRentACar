...
public class AdditionalServicesController {
    ...
    @PostMapping("/add")
    Result add(@RequestBody CreateAdditionalServiceRequest createAdditionalServiceRequest) throws AlreadyExistsException {return this.additionalServiceService.add(createAdditionalServiceRequest);}
    @GetMapping("/getById")
    DataResult<AdditionalServiceDto> getById(@RequestParam int id) throws NotFoundException {return this.additionalServiceService.getById(id);}
    @PutMapping("/update")
    Result update(@RequestBody UpdateAdditionalServiceRequest updateAdditionalServiceRequest) throws NotFoundException , UpdateHasNoChangesException {return this.additionalServiceService.update(updateAdditionalServiceRequest);}
    @DeleteMapping("/delete")
    Result delete(@RequestBody DeleteAdditionalServiceRequest deleteAdditionalServiceRequest) throws NotFoundException{return this.additionalServiceService.delete(deleteAdditionalServiceRequest);}
}
